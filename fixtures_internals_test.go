...
var fixtureCodecs = map[string]fixtureCodec{
	...
	"CompleteElicitationNotification": valueCodec[CompleteElicitationNotification](),
	"CreateElicitationRequest":        valueCodec[CreateElicitationRequest](),
	"CreateElicitationResponse":       valueCodec[CreateElicitationResponse](),
	"CreateTerminalRequest":           valueCodec[CreateTerminalRequest](),
	"ElicitationSchema":               valueCodec[ElicitationSchema](),
